...
const IMAGE_TYPE_OPTIONS = [
  { value: 'openclaw', label: 'OpenClaw Desktop', defaultImage: 'ghcr.io/openclaw/openclaw:latest' },
  ...
  { value: 'hermes-agent', label: 'Hermes Agent (Nous Research)', defaultImage: 'nousresearch/hermes-agent:latest' },
